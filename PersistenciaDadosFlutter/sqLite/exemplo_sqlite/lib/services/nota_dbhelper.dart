//arquivo para funcionar a conexão com banco de dados
...
class NotaDBhelper {
  ...
  static const String CREATE_TABLE_SQL =
      "CREATE TABLE IF NOT EXISTS $TABLE_NAME( id INTERGER PRIMARY KEY AUTOINCREMENT, titulo TEXT NOT NULL, conteudo TEXT NOT NULL)"
      "";
